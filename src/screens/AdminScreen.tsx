...
import { LockKeyhole, Printer, Plus, RefreshCw, WalletCards } from 'lucide-react'
...
export default function AdminScreen() {
  ...
  async function login(event: React.FormEvent) {
    ...
    try { const result = await apiClient.adminLogin(username, password); apiClient.setAccessToken(result.accessToken); setToken(result.accessToken) }
  ...
  async function updateStatus(id: string, status: string) {
    await apiClient.adminUpdatePrinterStatus(id, status); await refresh()
  }
